...
//   const projectId = url.pathname.split('/')[2];
//   const readOnlyMode = url.searchParams.has('readOnly');
//   const emailFromURL = url.searchParams.get('email'); // Extract email from URL
...
//   useEffect(() => {
//     if (loggedInEmail && emailFromURL && loggedInEmail !== emailFromURL) {
//       // Redirect or restrict access if emails do not match
//       alert('You do not have permission to access this page.');
//       navigate('/');
//     }
//   }, [loggedInEmail, emailFromURL, navigate]);
...
//       const uniqueId = uuidv4();
//       const expirationTime = new Date(Date.now() + 30 * 60 * 1000).toISOString();
//       const readOnlyLink = `http://rahul-ahlawat.io:5173/project/${projectId}?id=${uniqueId}&expires=${expirationTime}&selectedDate=${selectedDate}&selectedTl=${selectedTl}&selectedMember=${selectedMember}&email=${loggedInEmail}&readOnly=true`;
//        if (readOnlyMode) {
//         await storeRemarks();
//       } else {
//         await sendEmailWithLink(readOnlyLink);
...
//         <div>
//           <br />
//           <span> Project Name: {partProject.name}</span>
//         </div>
//         {readOnlyMode ? (
//           <div>
...
//               <Menu>
//                 <MenuButton as={Button} rightIcon={<ChevronDownIcon />}>
//                   {emailFromURL ? emailFromURL : 'Select Your Email'}
//                 </MenuButton>
//                 <MenuList>
//                   <MenuItem onClick={() => setLoggedInEmail(emailFromURL)}>
//                     {emailFromURL}
//                   </MenuItem>
//                 </MenuList>
//               </Menu>
